...
aphrodite_extension_sources = [
    ...
    "kernels/quantization/exllamav2/ext.cpp",
    "kernels/quantization/exllamav2/cuda/q_matrix.cu",
    "kernels/quantization/exllamav2/cuda/q_gemm.cu",
    "kernels/quantization/exllamav2/cuda/old_matmul_kernel.cu",
